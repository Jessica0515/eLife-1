...
public class ReservationKtv extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_reservation_ktv);

        Spinner spinner = findViewById(R.id.spinner);
        Spinner spinner1 = findViewById(R.id.spinner2);

        //上一頁
        Button buttonRBack = findViewById(R.id.ktvBack);
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (firstTime) {
                    ...
                    Toast.makeText(ReservationKtv.this, "Selected Date: " + selectedWeekDay.getName() , Toast.LENGTH_LONG).show();
                    //回傳值
        ...
        spinner1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent ,View view ,int position ,long id) {
                ...
                if (firstTime) {
                    ...
                    Toast.makeText(ReservationKtv.this, "Selected Time: " + selectedTime.getRange() , Toast.LENGTH_LONG).show();
