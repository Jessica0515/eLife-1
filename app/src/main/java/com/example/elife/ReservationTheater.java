        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (firstTime) {
                    ...
                    Toast.makeText(ReservationTheater.this, "Selected Date: " + selectedWeekDay.getName() , Toast.LENGTH_LONG).show();
                    //回傳值
        ...
        spinner1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent ,View view ,int position ,long id) {
                ...
                if (firstTime) {
                    ...
                    Toast.makeText(ReservationTheater.this, "Selected Time: " + selectedTime.getRange() , Toast.LENGTH_LONG).show();
